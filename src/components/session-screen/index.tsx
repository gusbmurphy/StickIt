...
const SessionScreen = () => <Text>Session Screen</Text>;

export default SessionScreen;

export const exerciseNameA11yLabel = 'Current exercise';
export const exerciseGroupA11yLavel = 'Exercise focus group';
export const exerciseInfoA11yLabel = 'Press to show more info on exercise';
